...
| **Version** | v0.5.2 — fixes the Cockpit settings save |
...
| **Maturity** | 6 releases (0.1.0 → 0.5.2), **45 ADRs**, **346** passing tests |
...
| Term | Definition |
|------|------------|
| **geekstackflow / tcgflow** | Creative GeekStack Flow — a zero-dependency Node CLI (v0.5.2, two bin names) that scaffolds and orchestrates a file-based AI-development workflow. |
